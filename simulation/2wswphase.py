...
from animats.prey2 import Prey2
...
class Simulator:
  def __init__(self):
    ...
    self.prey2 = pygame.image.load("../resources/fox.png")
    ...
    self.prey2         = pygame.transform.scale(self.prey2, (28,28))
  ...
  def draw(self, obj):
    ...
    if obj.name == 'prey2':
      #print obj.x, obj.y
      #self.screen.blit(pygame.transform.rotate(self.prey, obj.direct), (obj.x,obj.y))
      self.screen.blit(self.prey2, (obj.x-14,obj.y-14))
